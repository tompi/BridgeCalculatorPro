...
public class ContractViews extends ViewsHelper {
	...
	public Suit GetSuit() {
		if (!Suit[0].isEnabled()) {
			return com.brisco.Game.Suit.Clubs;
		}
		if (!Suit[1].isEnabled()) {
			return com.brisco.Game.Suit.Diamonds;
		}
		if (!Suit[2].isEnabled()) {
			return com.brisco.Game.Suit.Hearts;
		}
		if (!Suit[3].isEnabled()) {
			return com.brisco.Game.Suit.Spades;
		}
		if (!Suit[4].isEnabled()) {
			return com.brisco.Game.Suit.Notrump;
		}
		return null;
	}
